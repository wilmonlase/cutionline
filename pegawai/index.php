                ...
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            ...
                            <li>
                                <a href="index.php?halaman=data_user">Cuti Diluar Tanggungan Negara</a>
                            </li>
                            <li>
                                <a href="index.php?halaman=data_user">Cuti Tugas Belajar</a>
                            </li>
                             <li>
            ...
            <div id="page-inner">
                ...
                if (isset($_GET['halaman']))
                {
                       ...
                       elseif ($_GET["halaman"]=="cuti_alasan_penting")
                    {
                       ...
                       elseif ($_GET["halaman"]=="cuti_lain")
                    {
                        include 'cuti_lain.php';
                    }
