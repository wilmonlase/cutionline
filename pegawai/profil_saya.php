    ...
    <div class="col-md-6 col-md-offset-2">
      <form method="post">  
        ...
        <div class="form-group">
          ...
          <input type="text" name="gol_ruang" class="form-control" readonly>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
          ...
          <input type="text" name="unit_kerja" class="form-control" readonly>
        </div>
        <hr>

        <button name="kembali" class="btn btn-block btn-primary" href="index.php?halaman=halaman_utama"><i class="fa fa-telegram"></i>Kembali</button>
